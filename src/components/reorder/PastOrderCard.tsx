...
export function PastOrderCard({ order }: PastOrderCardProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      {/* Bottom row: total + reorder button with counter */}
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-amazon-orange hover:bg-amazon-orange/90 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors"
        >
          Reorder →
          {reorderCount > 0 && (
